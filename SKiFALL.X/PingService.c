...
uint8_t InitPingService(uint8_t Priority)
{
    ...
    ES_Timer_InitTimer(PING_TIMER, PING_TICKS);
...
//        ES_Timer_InitTimer(PING_TIMER, PING_TICKS);
        ...
        ReturnEvent.EventParam = D;
        
#ifndef PING_TEST           // keep this as is for test harness
        ...
        break;
#ifdef PING_TEST     // keep this as is for test harness      
    default:
//        printf("\r\nEvent: %s\tParam: 0x%X",
        printf("\r\nEvent: %s\tParam: %d",
