...
#define TRIS_COIL_A_ENABLE TRISEbits.TRISE1    //PORTZ_04 //PORTZ_06
//#define TRIS_COIL_A_ENABLE TRISDbits.TRISD0
...
//
#define COIL_A_ENABLE LATEbits.LATE1
//#define COIL_A_ENABLE LATDbits.LATD0
